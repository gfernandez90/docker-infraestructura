<aside class="w-64 bg-slate-900 text-slate-300 min-h-screen flex flex-col">
    <div class="p-5 font-bold text-lg text-white border-b border-slate-800">
        ⚙️ Infraestructura
    </div>
    <nav class="flex-1 p-4 space-y-1">
        <a href="/index.php?page=dashboard" class="flex items-center gap-3 px-4 py-3 rounded-lg hover:bg-slate-800 hover:text-white transition">
            📊 <span>Dashboard</span>
        </a>
        <a href="/index.php?page=configuraciones" class="flex items-center gap-3 px-4 py-3 rounded-lg hover:bg-slate-800 hover:text-white transition">
